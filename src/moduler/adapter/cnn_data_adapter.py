...
class CnnDataAdapter(Moduler):
    def __init__(
            self,
            featureFrame3dDir=None, targetBehaviorDir=None,
    ):
        super(CnnDataAdapter, self).__init__()
    ...
    def run(self):
        ...
        return CnnData(callings, predictDates, learnMFf3ds, predictTbs)
...
class CnnData(object):
    ...
    def loadFromCacheDir(cacheDir):
        cFilePaths = CnnData._CFilePaths(cacheDir)
    ...
    class _CFilePaths(object):
        def __init__(self, cacheDir):
            super(CnnData._CFilePaths, self).__init__()
...
class _CnnDataStat(Stat):
    def __init__(self):
        super(_CnnDataStat, self).__init__()
